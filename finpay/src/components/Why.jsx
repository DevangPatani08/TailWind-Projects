      ...
      <div className='w-full max-w-7xl px-6 md:px-10 flex flex-col items-center mx-auto'>
        ...
        <div className='w-full flex flex-col gap-12'>
          <div className='w-full flex flex-col lg:flex-row gap-12'>
            <div className='w-full lg:w-1/2 bg-green-100 p-8 rounded-2xl'>
          ...
          <div className='w-full bg-green-100 rounded-2xl px-8 pt-8 lg:px-12 lg:pt-12 flex flex-col lg:flex-row gap-10 lg:gap-20 overflow-hidden'>
